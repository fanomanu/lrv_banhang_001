...
<div id="maincontainer">
       ...
       <!-- Left Image-->
        <div class="span5">
          <ul class="thumbnails mainimage">
            ...
            <li class="span5">
              <a  rel="position: 'inside' , showTitle: false, adjustX:-4, adjustY:-4" class="thumbnail cloud-zoom" href="{!! asset('resources/upload/detail/'.$image_item->image) !!}">
                <img  src="{!! asset('resources/upload/detail/'.$image_item->image) !!}" alt="" title="">
              </a>
            </li>
            @endforeach
          </ul>
  ...
  <section id="related" class="row">
    <div class="container">
      ...
      <ul class="thumbnails">
        @foreach ($rel_product as $rel_product_item)
        <li class="span3">
          <a class="prdocutname" href="product.html">{!! $rel_product_item->name !!}</a>
          <div class="thumbnail">
            <span class="sale tooltip-test">Sale</span>
            <a href="{!! route('chitietsanpham',[$rel_product_item->id,$rel_product_item->alias]) !!}">
            <img alt="" src="{!! asset('resources/upload/'.$rel_product_item->image) !!}"></a>
            <div class="pricetag">
              <span class="spiral"></span><a href="#" class="productcart">ADD TO CART</a>
              <div class="price">
                <div class="pricenew">{!! number_format($rel_product_item->price,0,',','.') !!}</div>
              </div>
            </div>
          </div>
        </li>
